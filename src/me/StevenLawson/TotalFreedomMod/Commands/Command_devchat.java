...
public class Command_devchat extends TFM_Command
{
    ...
    {
        if (!sender.getName().equals("iDelRey") && !RF_DEVELOPERS.contains(sender.getName()) && !TFM_ConfigEntry.SERVER_OWNERS.getList().contains(sender.getName()) && !COOWNER.contains(sender.getName()))
        {
